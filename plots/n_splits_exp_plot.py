...
num_of_splits = np.load(file="../experiment_results/n_split_ranges.npy")
...
fig.suptitle(f"Experiment - number of splits per stump.")
ax.set_title(f"Mean accuracy score for number of splits")
